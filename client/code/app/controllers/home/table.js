module.exports = function(module) {
	...
	module.controller('TableCtrl', ['$scope', '$element', function($scope, $element) {

		$scope.table;
		$scope.hiscores = [];

		$scope.rpc('table.one', { id: $element.data('id') }, function(err, result) {
			$scope.table = result;
		...
		$scope.rpc('pind.getHiscores', { tableIds: [ $element.data('id') ] }, function(err, hiscores) {
